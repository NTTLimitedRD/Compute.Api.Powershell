// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ComputeApiClientException.cs" company="">
//   
// </copyright>
// <summary>
...
namespace DD.CBU.Compute.Api.Client
{
		...
		: ApiClientException
	{
		...
		/// </summary>
		private readonly ClientError _error;

		/// <summary>
		/// Initialises a new instance of the <see cref="ComputeApiClientException"/> class. 
		...
		/// Optional message format arguments.
		/// </param>
		public ComputeApiClientException(ClientError error, string messageOrFormat, Exception innerException, 
		...
		public override string ToString()
		{
			...
			var exceptionStringBuilder = new StringBuilder(base.ToString());
		...
		/// <summary>
		/// Create a <see cref="ComputeApiClientException"/> to be raised because the client is not currently logged into the
		///     CaaS API.
		/// </summary>
		/// <returns>
		...
		/// <summary>
		/// Create a <see cref="ComputeApiClientException"/> to be raised because the client is already logged into the CaaS
		///     API.
		/// </summary>
		/// <returns>
		/// The configured <see cref="ComputeApiClientException"/>.
