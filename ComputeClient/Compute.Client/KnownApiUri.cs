...
namespace DD.CBU.Compute.Api.Client
{
	...
	public enum KnownApiRegion
	{
		...
		/// <summary>
		/// The asia pacific_ ap.
		/// </summary>
		AsiaPacific_AP, 

		/// <summary>
		/// The south america_ sa.
		/// </summary>
		SouthAmerica_SA, 
	...
	public class KnownApiUri
	{
		...
		/// <summary>
		/// Prevents a default instance of the <see cref="KnownApiUri"/> class from being created. 
		///     Contructor
		/// </summary>
		private KnownApiUri()
		{
		...
		public Uri GetBaseUri(KnownApiVendor vendor, KnownApiRegion region)
		{
			...
			if (!KnownApiHostNames.ContainsKey(key))
				throw new ComputeApiException(ComputeApiError.BadRequest, 
					"Known Cloud API hostname not found with this vendor and region combination.", string.Empty, null, string.Empty);
