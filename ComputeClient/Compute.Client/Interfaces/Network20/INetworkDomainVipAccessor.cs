...
namespace DD.CBU.Compute.Api.Client.Interfaces.Network20
{
    ...
    public interface INetworkDomainVipAccessor
    {
        ...
        Task<pools> GetPoolsPaginated(PoolListOptions options = null, PageableRequest pagingOptions = null);
        ...
        /// <returns>The async task of <see cref="ResponseType"/></returns>
        Task<ResponseType> EditPool(editPool pool);
        ...
        Task<poolMembers> GetPoolMembersPaginated(PoolMemberListOptions options = null, PageableRequest pagingOptions = null);
        ...
        /// <param name="poolMemberId">The Pool Member id.</param>
        /// <returns>The async task of <see cref="ResponseType"/></returns>
        Task<ResponseType> DeletePoolMember(Guid poolMemberId);
    }
}
