...
namespace DD.CBU.Compute.Api.Client.Interfaces.Network20
{
    ...
    /// </summary>
    public interface IVipNodeManagement
    {
        /// <summary>
        ...
        Task<nodes> GetNodesPaginated(NodeListOptions options = null, PageableRequest pagingOptions = null);
        ...
        /// <returns>The async task of <see cref="ResponseType"/></returns>
        Task<ResponseType> EditNode(editNode node);
