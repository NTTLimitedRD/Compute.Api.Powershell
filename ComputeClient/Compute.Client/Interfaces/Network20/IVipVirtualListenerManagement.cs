...
namespace DD.CBU.Compute.Api.Client.Interfaces.Network20
{
    ...
    /// </summary>
    public interface IVipVirtualListenerManagement
    {
        /// <summary>
        ...
        Task<virtualListeners> GetVirtualListenersPaginated(VirtualListenerListOptions options = null, PageableRequest pagingOptions = null);
