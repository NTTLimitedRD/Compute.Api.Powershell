...
namespace DD.CBU.Compute.Api.Contracts.Vendor
{
    ...
    public partial class SummaryCustomerOrganizations
    {

        private SummaryCustomerOrganization[] itemsField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("SummaryCustomerOrganization")]
        public SummaryCustomerOrganization[] Items
        {
            get
            {
