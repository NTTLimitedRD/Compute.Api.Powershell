...
namespace DD.CBU.Compute.Api.Contracts.Network20
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("defaultPersistenceProfile", Namespace = "urn:didata.com:api:cloud:types", IsNullable = false)]
    public partial class DefaultPersistenceProfileType
    {
        ...
        public bool fallbackCompatible
        {
            get
            {
                return this.fallbackCompatibleField;
            }
            set
            {
                this.fallbackCompatibleField = value;
            }
        }
    }
    ...
    public partial class defaultPersistenceProfiles
    {
        ...
        public DefaultPersistenceProfileType[] defaultPersistenceProfile
        {
            get
            {
                return this.defaultPersistenceProfileField;
            }
            set
            {
                this.defaultPersistenceProfileField = value;
            }
        }
