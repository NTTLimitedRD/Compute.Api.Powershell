...
namespace Compute.Client.UnitTests
{
    ...
    public class ApiUriTests
    {
        ...
        public void ReturnsGetDomainNatRulesUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/network/natRule?networkDomainId="+networkDomainId, uri.OriginalString);
        }
        ...
        public void ReturnsGetNatRuleUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/network/natRule/"+ networkId, uri.OriginalString);
        }
        ...
        public void ReturnsCreatePoolUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/createPool", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolsUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/pool", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/pool/"+ poolId, uri.OriginalString);
        }
        ...
        public void ReturnsEditPoolUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/editPool", uri.OriginalString);
        }
        ...
        public void ReturnsDeletePoolUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/deletePool", uri.OriginalString);
        }
        ...
        public void ReturnsAddPoolMemberUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/addPoolMember", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolMembersUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/poolMember", uri.OriginalString);
        }
        ...
        public void ReturnsGetPoolMemberUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/poolMember/"+ memberId, uri.OriginalString);
        }
        ...
        public void ReturnsEditPoolMemberUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/editPoolMember", uri.OriginalString);
        }
        ...
        public void ReturnsDeletePoolMemberUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/removePoolMember", uri.OriginalString);
        }
        ...
        public void ReturnsAddVipNodeUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/createNode", uri.OriginalString);
        }
        ...
        public void ReturnsGetVipNodesUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/node", uri.OriginalString);
        }
        ...
        public void ReturnsGetVipNodeUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/node/"+ nodeId, uri.OriginalString);
        }
        ...
        public void ReturnsEditVipNodeUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/editNode", uri.OriginalString);
        }
        ...
        public void ReturnsDeleteVipNodeUri()
        {
            ...
            Assert.AreEqual("caas/2.0/" + _orgId + "/networkDomainVip/deleteNode", uri.OriginalString);
        }
    }
}