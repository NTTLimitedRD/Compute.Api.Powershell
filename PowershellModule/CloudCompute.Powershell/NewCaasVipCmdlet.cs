...
namespace DD.CBU.Compute.Powershell
{
    ...
    public class NewCaasVipCmdlet:PsCmdletCaasBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, HelpMessage = "The server farm for the VIP", ValueFromPipeline = true, ParameterSetName = "ServerFarm")]
        ...
        /// The Vip status
        /// </summary>
        [Parameter(Mandatory = false, HelpMessage = "The Vip IP address, If you do not supply an IP address, the next available public IP address from your network's public IP block(s)  will be assigned.")]
