// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCaasCustomerImageExportsCmdlet.cs" company="">
//   
// </copyright>
// <summary>
...
namespace DD.CBU.Compute.Powershell
{
	...
	public class GetCaasCustomerImageExportsCmdlet : PSCmdletCaasWithConnectionBase
	{
		...
		protected override void ProcessRecord()
		{
			...
			try
			{
				IEnumerable<ImageExportType> resultlist = GetCustomerImageExports();
...
// if (e is HttpRequestException)
		...
		{
			return Connection.ApiClient.ImportExportCustomerImage.GetCustomerImagesExports().Result;
		}
	}
}