...
namespace DD.CBU.Compute.Powershell.Mcp20
{
    ...
    /// <summary>
    ///     The Get drs pair report
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "CaasDrsUsageReport")]
    [OutputType(typeof(string))]
    public class GetDrsUsageReportCmdlet : PSCmdletCaasWithConnectionBase
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                var result = Connection.ApiClient.Reports.GetDrsPairsUsageReport(StartDate, EndDate.Value).Result;
