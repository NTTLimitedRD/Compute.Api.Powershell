...
namespace DD.CBU.Compute.Powershell.Mcp20
{
    ...
    /// <summary>
    ///     The Get backup report
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "CaasBackupUsageReport")]
    [OutputType(typeof(string))]
    public class GetBackupReportCmdlet : PSCmdletCaasWithConnectionBase
    {
        /// <summary>
        ///    Data Center ID
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipeline = true, HelpMessage = "Data Center ID")]
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                var result = Connection.ApiClient.Reports.GetBackupUsageReport(DatacenterId, StartDate, EndDate.Value).Result;
