...
namespace DD.CBU.Compute.Powershell.Mcp20
{
    ...
    [Cmdlet(VerbsCommon.Get, "CaasVipPools")]
    [OutputType(typeof(PoolType[]))]
    public class GetCaasVipPoolsCmdlet : PSCmdletCaasWithConnectionBase
    {
        /// <summary>
		///     Gets or sets the VIP Pool name.
		/// </summary>
		[Parameter(Mandatory = false, ParameterSetName = "Filtered", ValueFromPipeline = true, HelpMessage = "The VIP Pool name")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, ParameterSetName = "Filtered", ValueFromPipeline = true, HelpMessage = "The VIP Pool id")]
        public Guid PoolId { get; set; }

        /// <summary>
        ///     Gets or sets VIP Pool State
        /// </summary>
        [Parameter(Mandatory = false, ParameterSetName = "Filtered", ValueFromPipeline = true, HelpMessage = "The VIP Pool state")]
